...
//      text.draw(at: CGPoint(x: 0, y: 0), withAttributes: attributes)
        ...
        let titleBottom = addTitle(pageRect: pageRect, textToAdd: "CONTRACT DETAILS")
        
        let bodyContractor =  addBodyTextWithCG(pageRect: pageRect, textTop: titleBottom + 10.0, textBodyToAdd: title)
      
//      let bodyContractor =  addBodyText(pageRect: pageRect, textTop: titleBottom + 36.0, textBodyToAdd: "CONTRACTOR DETAILS")
        
     let contractorAddress =  addBodyTextWithCG(pageRect: pageRect, textTop: bodyContractor + 36.0, textBodyToAdd: "title")
...
//      addBodyText(pageRect: pageRect, textTop: imageBottom + 18.0)
  ...
  ///Add Title =====
    func addTitle(pageRect: CGRect,  textToAdd: String) -> CGFloat {
    // 1
  ...
  //========Add Paragraph for Long text ===
    func addBodyText(pageRect: CGRect, textTop: CGFloat, textBodyToAdd: String) {
    ...
    //========Add Paragraph for Long text ===
      func addBodyTextWithCG(pageRect: CGRect, textTop: CGFloat, textBodyToAdd: String) -> CGFloat {
      let textFont = UIFont.systemFont(ofSize: 12.0, weight: .regular)
      // 1
      let paragraphStyle = NSMutableParagraphStyle()
      paragraphStyle.alignment = .natural
